const MAINNET_CONTRACT_ADDRESSES = {
  ...
  liquidationQueueContract: 'terra1e25zllgag7j9xsun3me4stnye2pcg66234je3u',
};
...
const TESTNET_CONTRACT_ADDRESSES = {
  ...
  liquidationQueueContract: 'terra18j0wd0f62afcugw2rx5y8e6j5qjxd7d6qsc87r',
};

export function CONTRACT_ADDRESS(network) {
  if (network?.chainID.startsWith('bombay')) {
    return TESTNET_CONTRACT_ADDRESSES;
  } else {
    return MAINNET_CONTRACT_ADDRESSES;
  }
}
